  ...
  async.eachSeries(elements, (element, next) => {
    ...
    if (!Prism.languages[language]) {
      try {
        ...
        console.log(`${chalk.cyan('[prism-dom]')} Unrecognized language ${chalk.cyan(language)}, defaulting to ${chalk.cyan(defaultLanguage)}`);
        element.className = `language-${defaultLanguage}`;
        language = undefined;
      }
    }
